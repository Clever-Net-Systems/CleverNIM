<?php
$this->pageTitle = Yii::t('app', 'Export Fait_tagauto records');
$this->breadcrumbs = array(
	Yii::t('app', 'Export Fait_tagauto records'),
);
?><style>
...
<div class="grid_16 widget first">
	<div class="widget_title clearfix"><h2>Fait_tagauto exporter</h2></div>
