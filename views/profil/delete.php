<?php
$this->pageTitle = Yii::t('app', 'Delete Profil');
$this->breadcrumbs = array(
	Yii::t('app', 'Manage Profil') => array('admin'),
	Yii::t('app', 'Delete Profil'),
);
?>
<div class="clear"></div>
<div class="grid_16 widget first">
	...
	<div class="widget_body">
		<div class="widget_content">
			<p>Etes-vous sûr de vouloir supprimer <a class="codaPopupTrigger" rel="<?php echo $this->createUrl("profil/coda", array('id' => $model->id)); ?>" href="<?php echo $this->createUrl('profil/update', array('id' => $model->id)); ?>"><?php echo $model->_intname; ?></a> ?</p>
...
<?php echo CHtml::hiddenField('prevUri', $prevUri); ?>	<div class="row buttons">
		<?php echo CHtml::submitButton((count($objs) > 1) ? ('Supprimer ce Profil et les ' . (count($objs) - 1) . ' éléments associés') : 'Supprimer ce Profil', array('name' => 'confirm')); ?>		<?php echo CHtml::link('Annuler la suppression', isset($prevUri) ? $prevUri : "/profil/admin"); ?>	</div>
