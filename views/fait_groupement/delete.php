<?php
$this->pageTitle = Yii::t('app', 'Delete Fait_groupement');
$this->breadcrumbs = array(
	Yii::t('app', 'Manage Fait_groupement') => array('admin'),
	Yii::t('app', 'Delete Fait_groupement'),
);
?>
<div class="clear"></div>
<div class="grid_16 widget first">
	...
	<div class="widget_body">
		<div class="widget_content">
			<p>Etes-vous sûr de vouloir supprimer <a class="codaPopupTrigger" rel="<?php echo $this->createUrl("fait_groupement/coda", array('id' => $model->id)); ?>" href="<?php echo $this->createUrl('fait_groupement/update', array('id' => $model->id)); ?>"><?php echo $model->_intname; ?></a> ?</p>
...
<?php echo CHtml::hiddenField('prevUri', $prevUri); ?>	<div class="row buttons">
		<?php echo CHtml::submitButton((count($objs) > 1) ? ('Supprimer ce Fait_groupement et les ' . (count($objs) - 1) . ' éléments associés') : 'Supprimer ce Fait_groupement', array('name' => 'confirm')); ?>		<?php echo CHtml::link('Annuler la suppression', isset($prevUri) ? $prevUri : "/fait_groupement/admin"); ?>	</div>
