<?php
$this->pageTitle = Yii::t('app', 'Delete Poste');
$this->breadcrumbs = array(
	Yii::t('app', 'Manage Poste') => array('admin'),
	Yii::t('app', 'Delete Poste'),
);
?>
<div class="clear"></div>
<div class="grid_16 widget first">
	...
	<div class="widget_body">
		<div class="widget_content">
			<p>Etes-vous sûr de vouloir supprimer <a class="codaPopupTrigger" rel="<?php echo $this->createUrl("poste/coda", array('id' => $model->id)); ?>" href="<?php echo $this->createUrl('poste/update', array('id' => $model->id)); ?>"><?php echo $model->_intname; ?></a> ?</p>
...
<?php echo CHtml::hiddenField('prevUri', $prevUri); ?>	<div class="row buttons">
		<?php echo CHtml::submitButton((count($objs) > 1) ? ('Supprimer ce Poste et les ' . (count($objs) - 1) . ' éléments associés') : 'Supprimer ce Poste', array('name' => 'confirm')); ?>		<?php echo CHtml::link('Annuler la suppression', isset($prevUri) ? $prevUri : "/poste/admin"); ?>	</div>
