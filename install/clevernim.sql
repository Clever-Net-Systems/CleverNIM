...
INSERT INTO `AuthAssignment` VALUES ('Admin','1',NULL,'N;'),('Admin','12',NULL,'N;'),('Admin','13',NULL,'N;'),('Administrateur','8',NULL,'N;'),('AppAdmin','12',NULL,'N;'),('EZAdmin','12',NULL,'N;'),('EZAdmin','13',NULL,'N;'),('RA','4',NULL,'N;'),('RA','6',NULL,'N;'),('RA','7',NULL,'N;'),('RA','8',NULL,'N;'),('RA','9',NULL,'N;'),('StandardUser','15',NULL,'N;'),('TagAdmin','3',NULL,'N;');
...
INSERT INTO `AuthItem` VALUES ('Admin',2,'Admin [auto - ne pas utiliser]',NULL,'N;'),('AppAdmin',2,'Application administrator',NULL,'N;'),('AuditTrail.AuditAdmin.AuditAdmin',0,'View audit log records',NULL,'N;'),('Authenticated',2,'Authenticated user [auto - ne pas utiliser]','return !Yii::app()->user->isGuest;','N;'),('Base_Navigation',1,'Base_Navigation',NULL,'N;'),('CascadeDelete',0,'Delete cascading records',NULL,'N;'),('Ecole.Admin',0,'Access to Ecole admin interface',NULL,'N;'),('Ecole.Coda',0,'Access to Ecole popup information',NULL,'N;'),('Ecole.CodaAll',0,'View all Ecole popup records information',NULL,'N;'),('Ecole.CodaSelf',0,'View own Ecole popup records information',NULL,'N;'),('Ecole.Create',0,'Create Ecole records',NULL,'N;'),('Ecole.Delete',0,'Delete Ecole records',NULL,'N;'),('Ecole.Update',0,'Update Ecole records',NULL,'N;'),('Ecole.UpdateDeleteSelf',0,'Update own Ecole records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Ecole.ViewAll',0,'View all Ecole records',NULL,'N;'),('Ecole.ViewSelf',0,'View own Ecole records',NULL,'N;'),('Ecole_EditAll',1,'Edit all Ecole records',NULL,'N;'),('Ecole_EditSelf',1,'Edit own Ecole records',NULL,'N;'),('Ecole_ViewAll',1,'View all Ecole records',NULL,'N;'),('Ecole_ViewSelf',1,'View own Ecole records',NULL,'N;'),('EZAdmin',2,'System Administrator',NULL,'N;'),('Fait.Admin',0,'Access to Fait admin interface',NULL,'N;'),('Fait.Coda',0,'Access to Fait popup information',NULL,'N;'),('Fait.CodaAll',0,'View all Fait popup records information',NULL,'N;'),('Fait.CodaSelf',0,'View own Fait popup records information',NULL,'N;'),('Fait.Create',0,'Create Fait records',NULL,'N;'),('Fait.Delete',0,'Delete Fait records',NULL,'N;'),('Fait.Update',0,'Update Fait records',NULL,'N;'),('Fait.UpdateDeleteSelf',0,'Update own Fait records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Fait.ViewAll',0,'View all Fait records',NULL,'N;'),('Fait.ViewSelf',0,'View own Fait records',NULL,'N;'),('Fait_EditAll',1,'Edit all Fait records',NULL,'N;'),('Fait_EditSelf',1,'Edit own Fait records',NULL,'N;'),('Fait_groupement.Admin',0,'Access to Fait_groupement admin interface',NULL,'N;'),('Fait_groupement.Coda',0,'Access to Fait_groupement popup information',NULL,'N;'),('Fait_groupement.CodaAll',0,'View all Fait_groupement popup records information',NULL,'N;'),('Fait_groupement.CodaSelf',0,'View own Fait_groupement popup records information',NULL,'N;'),('Fait_groupement.Create',0,'Create Fait_groupement records',NULL,'N;'),('Fait_groupement.Delete',0,'Delete Fait_groupement records',NULL,'N;'),('Fait_groupement.Update',0,'Update Fait_groupement records',NULL,'N;'),('Fait_groupement.UpdateDeleteSelf',0,'Update own Fait_groupement records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Fait_groupement.ViewAll',0,'View all Fait_groupement records',NULL,'N;'),('Fait_groupement.ViewSelf',0,'View own Fait_groupement records',NULL,'N;'),('Fait_groupement_EditAll',1,'Edit all Fait_groupement records',NULL,'N;'),('Fait_groupement_EditSelf',1,'Edit own Fait_groupement records',NULL,'N;'),('Fait_groupement_ViewAll',1,'View all Fait_groupement records',NULL,'N;'),('Fait_groupement_ViewSelf',1,'View own Fait_groupement records',NULL,'N;'),('Fait_tagauto.Admin',0,'Access to Fait_tagauto admin interface',NULL,'N;'),('Fait_tagauto.Coda',0,'Access to Fait_tagauto popup information',NULL,'N;'),('Fait_tagauto.CodaAll',0,'View all Fait_tagauto popup records information',NULL,'N;'),('Fait_tagauto.CodaSelf',0,'View own Fait_tagauto popup records information',NULL,'N;'),('Fait_tagauto.Create',0,'Create Fait_tagauto records',NULL,'N;'),('Fait_tagauto.Delete',0,'Delete Fait_tagauto records',NULL,'N;'),('Fait_tagauto.Update',0,'Update Fait_tagauto records',NULL,'N;'),('Fait_tagauto.UpdateDeleteSelf',0,'Update own Fait_tagauto records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Fait_tagauto.ViewAll',0,'View all Fait_tagauto records',NULL,'N;'),('Fait_tagauto.ViewSelf',0,'View own Fait_tagauto records',NULL,'N;'),('Fait_tagauto_EditAll',1,'Edit all Fait_tagauto records',NULL,'N;'),('Fait_tagauto_EditSelf',1,'Edit own Fait_tagauto records',NULL,'N;'),('Fait_tagauto_ViewAll',1,'View all Fait_tagauto records',NULL,'N;'),('Fait_tagauto_ViewSelf',1,'View own Fait_tagauto records',NULL,'N;'),('Fait_ViewAll',1,'View all Fait records',NULL,'N;'),('Fait_ViewSelf',1,'View own Fait records',NULL,'N;'),('Groupement.Admin',0,'Access to Groupement admin interface',NULL,'N;'),('Groupement.Coda',0,'Access to Groupement popup information',NULL,'N;'),('Groupement.CodaAll',0,'View all Groupement popup records information',NULL,'N;'),('Groupement.CodaSelf',0,'View own Groupement popup records information',NULL,'N;'),('Groupement.Create',0,'Create Groupement records',NULL,'N;'),('Groupement.Delete',0,'Delete Groupement records',NULL,'N;'),('Groupement.Update',0,'Update Groupement records',NULL,'N;'),('Groupement.UpdateDeleteSelf',0,'Update own Groupement records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Groupement.ViewAll',0,'View all Groupement records',NULL,'N;'),('Groupement.ViewSelf',0,'View own Groupement records',NULL,'N;'),('Groupement_EditAll',1,'Edit all Groupement records',NULL,'N;'),('Groupement_EditSelf',1,'Edit own Groupement records',NULL,'N;'),('Groupement_ViewAll',1,'View all Groupement records',NULL,'N;'),('Groupement_ViewSelf',1,'View own Groupement records',NULL,'N;'),('Guest',2,'Unauthenticated user [auto - ne pas utiliser]','return Yii::app()->user->isGuest;','N;'),('Internal_Admin',1,'Edit internal settings and security',NULL,'N;'),('Internal_View',1,'View internal settings and security',NULL,'N;'),('Poste.Admin',0,'Access to Poste admin interface',NULL,'N;'),('Poste.Coda',0,'Access to Poste popup information',NULL,'N;'),('Poste.CodaAll',0,'View all Poste popup records information',NULL,'N;'),('Poste.CodaSelf',0,'View own Poste popup records information',NULL,'N;'),('Poste.Create',0,'Create Poste records',NULL,'N;'),('Poste.Delete',0,'Delete Poste records',NULL,'N;'),('Poste.Update',0,'Update Poste records',NULL,'N;'),('Poste.UpdateDeleteSelf',0,'Update own Poste records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Poste.updateEditable',0,'Update Poste records via Ajax',NULL,NULL),('Poste.ViewAll',0,'View all Poste records',NULL,'N;'),('Poste.ViewSelf',0,'View own Poste records',NULL,'N;'),('Poste_EditAll',1,'Edit all Poste records',NULL,'N;'),('Poste_EditSelf',1,'Edit own Poste records',NULL,'N;'),('Poste_ViewAll',1,'View all Poste records',NULL,'N;'),('Poste_ViewSelf',1,'View own Poste records',NULL,'N;'),('Profil.Admin',0,'Access to Profil admin interface',NULL,'N;'),('Profil.Coda',0,'Access to Profil popup information',NULL,'N;'),('Profil.CodaAll',0,'View all Profil popup records information',NULL,'N;'),('Profil.CodaSelf',0,'View own Profil popup records information',NULL,'N;'),('Profil.Create',0,'Create Profil records',NULL,'N;'),('Profil.Delete',0,'Delete Profil records',NULL,'N;'),('Profil.Update',0,'Update Profil records',NULL,'N;'),('Profil.UpdateDeleteSelf',0,'Update own Profil records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Profil.ViewAll',0,'View all Profil records',NULL,'N;'),('Profil.ViewSelf',0,'View own Profil records',NULL,'N;'),('Profil_EditAll',1,'Edit all Profil records',NULL,'N;'),('Profil_EditSelf',1,'Edit own Profil records',NULL,'N;'),('Profil_ViewAll',1,'View all Profil records',NULL,'N;'),('Profil_ViewSelf',1,'View own Profil records',NULL,'N;'),('RA',2,'Un RA (PC ou MAC)',NULL,'N;'),('Selection.Admin',0,'Access to Selection admin interface',NULL,'N;'),('Selection.Coda',0,'Access to Selection popup information',NULL,'N;'),('Selection.CodaAll',0,'View all Selection popup records information',NULL,'N;'),('Selection.CodaSelf',0,'View own Selection popup records information',NULL,'N;'),('Selection.Create',0,'Create Selection records',NULL,'N;'),('Selection.Delete',0,'Delete Selection records',NULL,'N;'),('Selection.Update',0,'Update Selection records',NULL,'N;'),('Selection.UpdateDeleteSelf',0,'Update own Selection records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Selection.ViewAll',0,'View all Selection records',NULL,'N;'),('Selection.ViewSelf',0,'View own Selection records',NULL,'N;'),('Selection_EditAll',1,'Edit all Selection records',NULL,'N;'),('Selection_EditSelf',1,'Edit own Selection records',NULL,'N;'),('Selection_ViewAll',1,'View all Selection records',NULL,'N;'),('Selection_ViewSelf',1,'View own Selection records',NULL,'N;'),('Site.Error',0,'View error pages',NULL,'N;'),('Site.Home',0,'View site homepage',NULL,'N;'),('Site.Index',0,'View site entry page',NULL,'N;'),('Site.Login',0,'Site login page',NULL,'N;'),('Site.Logout',0,'Site logout action',NULL,'N;'),('StandardUser',2,'Standard application user',NULL,'N;'),('Tag.Admin',0,'Access to Tag admin interface',NULL,'N;'),('Tag.Coda',0,'Access to Tag popup information',NULL,'N;'),('Tag.CodaAll',0,'View all Tag popup records information',NULL,'N;'),('Tag.CodaSelf',0,'View own Tag popup records information',NULL,'N;'),('Tag.Create',0,'Create Tag records',NULL,'N;'),('Tag.Delete',0,'Delete Tag records',NULL,'N;'),('Tag.Update',0,'Update Tag records',NULL,'N;'),('Tag.UpdateDeleteSelf',0,'Update own Tag records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Tag.ViewAll',0,'View all Tag records',NULL,'N;'),('Tag.ViewSelf',0,'View own Tag records',NULL,'N;'),('TagAdmin',2,'Un utilisateur ayant le droit de créer des tags manuels',NULL,'N;'),('Tagauto.Admin',0,'Access to Tagauto admin interface',NULL,'N;'),('Tagauto.Coda',0,'Access to Tagauto popup information',NULL,'N;'),('Tagauto.CodaAll',0,'View all Tagauto popup records information',NULL,'N;'),('Tagauto.CodaSelf',0,'View own Tagauto popup records information',NULL,'N;'),('Tagauto.Create',0,'Create Tagauto records',NULL,'N;'),('Tagauto.Delete',0,'Delete Tagauto records',NULL,'N;'),('Tagauto.Update',0,'Update Tagauto records',NULL,'N;'),('Tagauto.UpdateDeleteSelf',0,'Update own Tagauto records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Tagauto.ViewAll',0,'View all Tagauto records',NULL,'N;'),('Tagauto.ViewSelf',0,'View own Tagauto records',NULL,'N;'),('Tagauto_EditAll',1,'Edit all Tagauto records',NULL,'N;'),('Tagauto_EditSelf',1,'Edit own Tagauto records',NULL,'N;'),('Tagauto_ViewAll',1,'View all Tagauto records',NULL,'N;'),('Tagauto_ViewSelf',1,'View own Tagauto records',NULL,'N;'),('Tagparam.Admin',0,'Access to Tagparam admin interface',NULL,'N;'),('Tagparam.Coda',0,'Access to Tagparam popup information',NULL,'N;'),('Tagparam.CodaAll',0,'View all Tagparam popup records information',NULL,'N;'),('Tagparam.CodaSelf',0,'View own Tagparam popup records information',NULL,'N;'),('Tagparam.Create',0,'Create Tagparam records',NULL,'N;'),('Tagparam.Delete',0,'Delete Tagparam records',NULL,'N;'),('Tagparam.Update',0,'Update Tagparam records',NULL,'N;'),('Tagparam.UpdateDeleteSelf',0,'Update own Tagparam records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Tagparam.ViewAll',0,'View all Tagparam records',NULL,'N;'),('Tagparam.ViewSelf',0,'View own Tagparam records',NULL,'N;'),('Tagparam_EditAll',1,'Edit all Tagparam records',NULL,'N;'),('Tagparam_EditSelf',1,'Edit own Tagparam records',NULL,'N;'),('Tagparam_ViewAll',1,'View all Tagparam records',NULL,'N;'),('Tagparam_ViewSelf',1,'View own Tagparam records',NULL,'N;'),('Tag_EditAll',1,'Edit all Tag records',NULL,'N;'),('Tag_EditSelf',1,'Edit own Tag records',NULL,'N;'),('Tag_ViewAll',1,'View all Tag records',NULL,'N;'),('Tag_ViewSelf',1,'View own Tag records',NULL,'N;'),('Typetag.Admin',0,'Access to Typetag admin interface',NULL,'N;'),('Typetag.Coda',0,'Access to Typetag popup information',NULL,'N;'),('Typetag.CodaAll',0,'View all Typetag popup records information',NULL,'N;'),('Typetag.CodaSelf',0,'View own Typetag popup records information',NULL,'N;'),('Typetag.Create',0,'Create Typetag records',NULL,'N;'),('Typetag.Delete',0,'Delete Typetag records',NULL,'N;'),('Typetag.Update',0,'Update Typetag records',NULL,'N;'),('Typetag.UpdateDeleteSelf',0,'Update own Typetag records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Typetag.ViewAll',0,'View all Typetag records',NULL,'N;'),('Typetag.ViewSelf',0,'View own Typetag records',NULL,'N;'),('Typetag_EditAll',1,'Edit all Typetag records',NULL,'N;'),('Typetag_EditSelf',1,'Edit own Typetag records',NULL,'N;'),('Typetag_ViewAll',1,'View all Typetag records',NULL,'N;'),('Typetag_ViewSelf',1,'View own Typetag records',NULL,'N;'),('User.Admin',0,'User.Admin',NULL,'N;'),('User.Coda',0,'User.Coda',NULL,'N;'),('User.Create',0,'User.Create',NULL,'N;'),('User.Delete',0,'User.Delete',NULL,'N;'),('User.Update',0,'User.Update',NULL,'N;'),('User.UpdateSelf',0,'User.UpdateSelf','return Yii::app()->user->id == $params[\"id\"];','N;'),('User_EditAll',1,'User_EditAll',NULL,'N;'),('User_UpdateSelf',1,'User_UpdateSelf',NULL,'N;'),('User_View',1,'User_View',NULL,'N;'),('Valeurparam.Admin',0,'Access to Valeurparam admin interface',NULL,'N;'),('Valeurparam.Coda',0,'Access to Valeurparam popup information',NULL,'N;'),('Valeurparam.CodaAll',0,'View all Valeurparam popup records information',NULL,'N;'),('Valeurparam.CodaSelf',0,'View own Valeurparam popup records information',NULL,'N;'),('Valeurparam.Create',0,'Create Valeurparam records',NULL,'N;'),('Valeurparam.Delete',0,'Delete Valeurparam records',NULL,'N;'),('Valeurparam.Update',0,'Update Valeurparam records',NULL,'N;'),('Valeurparam.UpdateDeleteSelf',0,'Update own Valeurparam records','return Yii::app()->user->id == $params[\"userid\"];','N;'),('Valeurparam.ViewAll',0,'View all Valeurparam records',NULL,'N;'),('Valeurparam.ViewSelf',0,'View own Valeurparam records',NULL,'N;'),('Valeurparam_EditAll',1,'Edit all Valeurparam records',NULL,'N;'),('Valeurparam_EditSelf',1,'Edit own Valeurparam records',NULL,'N;'),('Valeurparam_ViewAll',1,'View all Valeurparam records',NULL,'N;'),('Valeurparam_ViewSelf',1,'View own Valeurparam records',NULL,'N;'),('Visiteur',2,'Visiteur - ne peut rien modifier',NULL,'N;');
...
CREATE TABLE `fait` (
  ...
  KEY `fait_fk_selection_19` (`selection_id`),
  CONSTRAINT `fait_fk_selection_19` FOREIGN KEY (`selection_id`) REFERENCES `selection` (`id`),
