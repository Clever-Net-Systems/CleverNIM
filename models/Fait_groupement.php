...
class Fait_groupement extends EZActiveRecord {
	...
	public function checkValue($val) {
		switch (Fait_groupement::getOperateur_values($this->operateur)) {
	...
	public function beforeSave() {
		$this->_intname = "" . $this->fact . " " . Fait_groupement::getOperateur_values($this->operateur) . " " . $this->valeur . "";
	...
	public function search() {
		...
		if (!Yii::app()->user->checkAccess("Fait_groupement.ViewAll") && Yii::app()->user->checkAccess('Fait_groupement.ViewSelf')) {
